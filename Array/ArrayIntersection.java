...
//        arrays/lists contain a particular value or to put it in other words, when there is a common value that exists
...
public class ArrayIntersection {
    ...
    public static void findIntersection(int arr[],int arr2 []){
