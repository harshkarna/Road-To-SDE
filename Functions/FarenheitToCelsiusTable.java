...
//        Start value is 120, end value is 200 and step size is 40. Therefore, the values we need to
//        convert are 120, 120 + 40 = 160, and 160 + 40 = 200.
//        The formula for converting Fahrenheit to Celsius is:
//        Celsius Value = (5/9)*(Fahrenheit Value - 32)
//        Plugging 120 into the formula, the celsius value will
//        be (5 / 9)*(120 - 32) => (5 / 9) * 88 => (5 * 88) / 9 => 440 / 9 => 48.88
...
public class FarenheitToCelsiusTable {
    ...
    public static void FTC(int s,int e,int step){
        int c;
        while (s<=e){
            c=(5 *(s-32))/9;
