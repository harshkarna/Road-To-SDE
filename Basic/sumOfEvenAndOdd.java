...
//        separately.
//        Digits mean numbers, not the places! That is, if the given integer is "13245", even digits are 2 & 4 and odd
//        digits are 1, 3 & 5.
//        Input format :
//        Integer N
//        Output format :
...
//        to be 8(2 + 2 + 4) and similarly, if we look at the odd digits, they are, 5, 5 and 5 which makes a sum of
