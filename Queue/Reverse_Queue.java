//Reverse Queue
//
//        You have been given a queue that can store integers as the data. You are required to write a function
//        that reverses the populated queue itself without using any other data structures.
//        Example:
//        Alt txt
//
//        Alt txt
...
public class Reverse_Queue {
    ...
    public static void reverse_queue(Queue<Integer> queue){
