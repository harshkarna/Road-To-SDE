...
public class LongestCommonSubsequence {
    ...
    private static int getLongestCommonSubsequenceIterative(String str1, String str2) {
        ...
        //first lets fill the array with 0
    ...
    private static int getLongestCommonSubsequencemMemo(String str1, String str2, int i , int j,int[][] dp) {
        //base case
        if(i >=str1.length() || j >=str2.length()){
            return 0;
        }
        ...
        if(str1.charAt(i)==str2.charAt(j)){
            int smallAns= getLongestCommonSubsequencemMemo(str1,str2,i+1,j+1,dp);
            dp[i][j]=1+smallAns;
        }
        else{
            int ans1=getLongestCommonSubsequencemMemo(str1,str2,i+1,j,dp);
            int ans2=getLongestCommonSubsequencemMemo(str1,str2,i,j+1,dp);
