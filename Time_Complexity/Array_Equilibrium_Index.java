...
//        is equal to the sum of elements at indices [(i + 1) to (N-1)]. One thing to note here is, the item at the index 'i' is not
...
//        Hence index 2 is an equilibrium index according to the condition we want to achieve. Mind it that we haven't included the item at
//        index 2, which is 10, to either of the parts.
//
...
public class Array_Equilibrium_Index {
    ...
    public static int equilibrium_index_new(int arr[]){
        int total_sum=0;
       int rsum=0;
       int lsum=0;
        int i=0;
...
//       equilibirium_index(arr);
        System.out.println(equilibrium_index_new(arr));
