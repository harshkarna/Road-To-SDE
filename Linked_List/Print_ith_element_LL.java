...
public class Print_ith_element_LL {
    ...
    public static void print_ith_elemnet(Node<Integer> head, int index){
        ...
        System.out.println("Value of Ith index " + index + " is " + temp.data);
