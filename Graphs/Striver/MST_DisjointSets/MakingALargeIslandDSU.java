...
public class MakingALargeIslandDSU {
    ...
    public int largestIsland(int[][] grid) {
        int n = grid.length;
        DisjointSetv1 ds=new DisjointSetv1(n * n);

        // step - 1
        //figuring our the connected components
        ...
        // step 2
        //traversing through every zero and and the seeing its adjacent if its connected to some
        //component then , adding its total size and at last returning max size
        // step 2
        int mx = 0;
        for (int row = 0; row < n; row++) {
            for (int col = 0; col < n; col++) {
